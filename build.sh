...
echo "  kpackagetool6 --type=Plasma/Applet --install $OUTPUT_FILE"
echo ""
echo "To upgrade an existing installation, run:"
echo "  kpackagetool6 --type=Plasma/Applet --upgrade $OUTPUT_FILE"
echo ""
echo "To uninstall, run:"
echo "  kpackagetool6 --type=Plasma/Applet --remove $PACKAGE_NAME"